  ...
  return (
    <header className='bg-background sticky top-0 flex h-16 items-center gap-4 border-b px-4 md:px-6'>
      <nav className='hidden flex-row gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-6'>
        ...
        <a
          href='/service1'
          className={`${service === 'service1' ? 'text-foreground' : 'text-muted-foreground'} hover:text-foreground whitespace-nowrap transition-colors`}
        >
          Service 1
        </a>
        <a
          href='/service2'
          className={`${service === 'service2' ? 'text-foreground' : 'text-muted-foreground'} hover:text-foreground whitespace-nowrap transition-colors`}
        >
          Service 2
        </a>
      </nav>
